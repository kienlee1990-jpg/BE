<template>
    <div :class="['app-shell', colorThemeClass]">
            ...
            <header class="topbar">
                ...
                <div class="topbar-right">
                    <button type="button" class="font-toggle-btn" @click="toggleColorTheme">
                        <i :class="['bi', colorTheme === 'dark' ? 'bi-sun-fill' : 'bi-moon-stars-fill']"></i>
...
<script setup>
    ...
    const colorThemeLabel = computed(() =>
        colorTheme.value === 'dark' ? 'Giao diện tối' : 'Giao diện sáng'
    )

    const colorThemeClass = computed(() =>
        colorTheme.value === 'dark' ? 'theme-royal' : 'theme-default'
    )
    ...
    onMounted(async () => {
        colorTheme.value = localStorage.getItem(COLOR_THEME_KEY) || 'light'
        applyColorTheme()
...
<style scoped>
    * {
    ...
    .app-shell.theme-royal {
        background:
            radial-gradient(circle at top left, rgba(95, 132, 209, 0.14), transparent 24%),
            linear-gradient(180deg, #071126 0%, #0a1730 44%, #0e1c37 100%);
        color: #edf3ff;
    }
    ...
    .app-shell.theme-royal .brand-text p {
    ...
    .app-shell.theme-royal .icon-btn {
    ...
    .app-shell.theme-royal .section-label {
    ...
    .app-shell.theme-royal .nav-item:hover,
    .app-shell.theme-royal .nav-item.active,
    .app-shell.theme-royal .nav-toggle:hover {
    ...
    .app-shell.theme-royal .sub-menu {
    ...
    .app-shell.theme-royal .sub-item:hover,
    .app-shell.theme-royal .sub-item.active {
    ...
    .app-shell.theme-royal .topbar {
        background:
            linear-gradient(90deg, rgba(12, 24, 48, 0.96), rgba(16, 32, 62, 0.96)),
            linear-gradient(180deg, #122449, #0d1c38);
        border-bottom-color: rgba(111, 143, 216, 0.16);
    }
    ...
    .app-shell.theme-royal .topbar-left h2 {
        color: #edf3ff;
    }
    ...
    .app-shell.theme-royal .topbar-left p {
        color: #9bb0d7;
    }
    ...
    .app-shell.theme-royal .font-toggle-btn {
        border-color: rgba(111, 143, 216, 0.18);
        background: linear-gradient(180deg, rgba(20, 38, 74, 0.94), rgba(12, 27, 55, 0.9));
        color: #edf3ff;
    }

    .app-shell.theme-royal .font-toggle-btn:hover {
        background: linear-gradient(180deg, rgba(28, 49, 92, 0.98), rgba(17, 34, 67, 0.96));
    }
    ...
    .app-shell.theme-royal .context-badge {
        background: linear-gradient(180deg, rgba(15, 30, 59, 0.92), rgba(10, 22, 44, 0.88));
        border-color: rgba(111, 143, 216, 0.16);
    }
    ...
    .app-shell.theme-royal .context-badge .label {
        color: #9bb0d7;
    }
    ...
    .app-shell.theme-royal .context-badge strong {
        color: #edf3ff;
    }
    ...
    .app-shell.theme-royal .user-menu {
        border-color: rgba(111, 143, 216, 0.16);
        background: linear-gradient(180deg, rgba(15, 30, 59, 0.94), rgba(10, 22, 44, 0.9));
    }
    ...
    .app-shell.theme-royal .user-menu i.bi-person-circle {
        color: #5f84d1;
    }
    ...
    .app-shell.theme-royal .user-meta span {
        color: #9bb0d7;
    }
    ...
    .app-shell.theme-royal .user-dropdown-menu {
        background: linear-gradient(180deg, rgba(14, 28, 53, 0.98), rgba(10, 21, 42, 0.96));
        border-color: rgba(111, 143, 216, 0.18);
    }
    ...
    .app-shell.theme-royal .dropdown-item:hover {
    ...
    .app-shell.theme-royal .vn-header p {
        color: #9bb0d7;
    }
</style>
