    ...
    * {
    ...
    .app-shell.theme-royal .sidebar {
        background:
            ...
            linear-gradient(180deg, #072214 0%, #0b351e 48%, #104b2b 100%);
    }
    ...
    .app-shell.theme-royal .brand {
        border-bottom-color: rgba(218, 184, 95, 0.22);
    }
    ...
    .app-shell.theme-royal .icon-btn {
        background: linear-gradient(180deg, rgba(216, 173, 82, 0.22), rgba(255, 255, 255, 0.08));
        color: #fff8e6;
    }
    ...
    .app-shell.theme-royal .nav-toggle:hover {
        ...
        box-shadow: inset 0 0 0 1px rgba(232, 200, 125, 0.16);
    }
    ...
    .app-shell.theme-royal .sub-menu {
        border-left-color: rgba(218, 184, 95, 0.2);
    }
    ...
    .app-shell.theme-royal .sub-item.active {
        background: linear-gradient(90deg, rgba(216, 173, 82, 0.16), rgba(255, 255, 255, 0.08));
        color: #fffdf5;
    }
