        ...
        <div class="content-shell">
            <header class="topbar">
                ...
                <div class="topbar-right">
                    <button type="button" class="font-toggle-btn" @click="toggleColorTheme">
                        <i class="bi bi-palette"></i>
                        <span>{{ colorThemeLabel }}</span>
                    </button>
...
<script setup>
    ...
    const COLOR_THEME_KEY = 'ui_color_theme'
    ...
    const colorThemeLabel = computed(() =>
        colorTheme.value === 'royal' ? 'Màu xanh thép' : 'Màu xanh vàng'
    )

    const applyColorTheme = () => {
        document.body.setAttribute('data-color-theme', colorTheme.value)
    }

    const toggleColorTheme = () => {
        colorTheme.value = colorTheme.value === 'royal' ? 'default' : 'royal'
        localStorage.setItem(COLOR_THEME_KEY, colorTheme.value)
        applyColorTheme()
    }
    ...
    onMounted(async () => {
        colorTheme.value = localStorage.getItem(COLOR_THEME_KEY) || 'default'
        applyColorTheme()
...
<style scoped>
    * {
    ...
    :global(body[data-color-theme="royal"]) .app-shell {
        background:
            radial-gradient(circle at top left, rgba(95, 132, 209, 0.16), transparent 24%),
            linear-gradient(180deg, #edf4ff 0%, #e3ecfb 44%, #f6f9ff 100%);
        color: #13213d;
    }
    ...
    .sidebar {
        ...
        background:
            ...
            linear-gradient(180deg, #0a1735 0%, #0c244f 52%, #102f66 100%);
        color: #fff;
        padding: 20px 14px;
    ...
    :global(body[data-color-theme="royal"]) .sidebar {
        background:
            radial-gradient(circle at top left, rgba(119, 156, 229, 0.24), transparent 26%),
            linear-gradient(180deg, #08152f 0%, #0d2452 48%, #183b7d 100%);
    }
    ...
    :global(body[data-color-theme="royal"]) .brand {
        border-bottom-color: rgba(124, 155, 219, 0.26);
    }
    ...
    :global(body[data-color-theme="royal"]) .brand-text p {
    ...
    :global(body[data-color-theme="royal"]) .icon-btn {
        background: linear-gradient(180deg, rgba(125, 147, 200, 0.26), rgba(255, 255, 255, 0.08));
        color: #eef4ff;
    }
    ...
    :global(body[data-color-theme="royal"]) .section-label {
        color: rgba(204, 221, 255, 0.72);
    }
    ...
    :global(body[data-color-theme="royal"]) .nav-item:hover,
    :global(body[data-color-theme="royal"]) .nav-item.active,
    :global(body[data-color-theme="royal"]) .nav-toggle:hover {
        background: linear-gradient(90deg, rgba(111, 143, 216, 0.24), rgba(255, 255, 255, 0.08));
        box-shadow: inset 0 0 0 1px rgba(153, 180, 240, 0.18);
    }
    ...
    :global(body[data-color-theme="royal"]) .sub-menu {
        border-left-color: rgba(148, 175, 233, 0.24);
    }
    ...
    :global(body[data-color-theme="royal"]) .sub-item:hover,
    :global(body[data-color-theme="royal"]) .sub-item.active {
    ...
    :global(body[data-color-theme="royal"]) .topbar {
        background:
            linear-gradient(90deg, rgba(239, 245, 255, 0.96), rgba(226, 236, 255, 0.96)),
            linear-gradient(180deg, #dfe9ff, #bfd2ff);
        border-bottom-color: rgba(111, 143, 216, 0.24);
    }
    ...
    :global(body[data-color-theme="royal"]) .topbar-left h2 {
        color: #14346e;
    }
    ...
    :global(body[data-color-theme="royal"]) .topbar-left p {
        color: #617399;
    }
    ...
    :global(body[data-color-theme="royal"]) .font-toggle-btn {
        border-color: rgba(111, 143, 216, 0.22);
        background: linear-gradient(180deg, rgba(255, 255, 255, 0.94), rgba(227, 236, 255, 0.9));
        color: #15356d;
    }

    :global(body[data-color-theme="royal"]) .font-toggle-btn:hover {
        background: linear-gradient(180deg, rgba(245, 249, 255, 1), rgba(208, 224, 255, 0.96));
    }
    ...
    :global(body[data-color-theme="royal"]) .context-badge {
        background: linear-gradient(180deg, rgba(255, 255, 255, 0.92), rgba(227, 236, 255, 0.88));
        border-color: rgba(111, 143, 216, 0.2);
    }
    ...
    :global(body[data-color-theme="royal"]) .context-badge .label {
        color: #617399;
    }
    ...
    :global(body[data-color-theme="royal"]) .context-badge strong {
        color: #16356d;
    }
    ...
    :global(body[data-color-theme="royal"]) .user-menu {
        border-color: rgba(111, 143, 216, 0.22);
        background: linear-gradient(180deg, rgba(255, 255, 255, 0.94), rgba(227, 236, 255, 0.9));
    }
    ...
    :global(body[data-color-theme="royal"]) .user-menu i.bi-person-circle {
        color: #5f84d1;
    }
    ...
    :global(body[data-color-theme="royal"]) .user-meta span {
        color: #617399;
    }
    ...
    :global(body[data-color-theme="royal"]) .user-dropdown-menu {
    ...
    :global(body[data-color-theme="royal"]) .dropdown-item:hover {
    ...
    :global(body[data-color-theme="royal"]) .vn-header p {
        color: #617399;
    }
</style>
