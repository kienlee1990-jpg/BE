...
namespace KPITrackerAPI.Services
{
    public class DonViService : IDonViService
    {
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (hasChildren)
                throw new Exception("Không th? xóa vì don v? này dang có don v? con.");
            ...
            if (isUsedInChiTietGiao)
                throw new Exception("Không th? xóa vì don v? này dang du?c s? d?ng trong chi ti?t giao ch? tiêu.");
